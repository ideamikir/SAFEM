...
/*
    ...
    3.600.000 for first liquidity on pancakeswap.
    The rest will be unlocked by vesting for 3 years with quarterly periods.
    We have reserved this 50% for this purposes,
        for the purpose of providing liquidity to other platforms,
        for airdrop purposes,
        for staking and rewards purposes,
        for team and marketing splitting,
        for giveaway to team and community,
        and other operations that may be needed.
    
    %𝟏𝟎.𝟎 Tax On Fair Launch Date
        Taxes can be used for anything.
        The lowest and highest tax rates are between %0.35 and %10.00.
        If the token does not need the market growth from taxes in the future,
        it will be reduced to these rates,
        if I can reach my future projects, the tax rate can will be reduced to %0.0.
*/
//_______________//
/*
    Go to the end of the source code for more information.
*/
//_______________//
...
/*  𝐈 𝐚𝐦 𝐧𝐨𝐭 𝐭𝐡𝐞 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐨𝐟 𝐭𝐡𝐢𝐬 𝐜𝐨𝐧𝐭𝐫𝐚𝐜𝐭.
        𝐁𝐮𝐭 𝐈 𝐭𝐡𝐢𝐧𝐤 𝐭𝐡𝐞 𝐌𝐢𝐧𝐭 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧 𝐡𝐞𝐫𝐞 𝐚𝐧𝐝 𝐭𝐡𝐞 𝐟𝐨𝐥𝐥𝐨𝐰𝐢𝐧𝐠 𝐜𝐨𝐝𝐞𝐬...
            𝐚𝐫𝐞 𝐧𝐨𝐭 𝐜𝐨𝐝𝐞𝐬 𝐭𝐡𝐚𝐭 𝐜𝐚𝐧 𝐛𝐞 𝐮𝐬𝐞𝐝 𝐟𝐨𝐫 𝐭𝐡𝐞 𝐦𝐢𝐧𝐭 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧 𝐥𝐚𝐭𝐞𝐫 𝐨𝐧.
                𝐈 𝐭𝐫𝐢𝐞𝐝 𝐭𝐨 𝐫𝐞𝐦𝐨𝐯𝐞 𝐌𝐢𝐧𝐭 𝐜𝐨𝐝𝐞𝐬, 𝐛𝐮𝐭 𝐟𝐨𝐫 𝐧𝐨𝐰,
                     𝐦𝐲 𝐒𝐨𝐥𝐢𝐝𝐢𝐭𝐲 𝐜𝐨𝐝𝐞 𝐤𝐧𝐨𝐰𝐥𝐞𝐝𝐠𝐞 𝐢𝐬 𝐧𝐨𝐭 𝐞𝐧𝐨𝐮𝐠𝐡 𝐭𝐨 𝐫𝐞𝐦𝐨𝐯𝐞 𝐭𝐡𝐨𝐬𝐞 𝐜𝐨𝐝𝐞𝐬...
                        𝐨𝐫 𝐮𝐧𝐝𝐞𝐫𝐬𝐭𝐚𝐧𝐝 𝐭𝐡𝐞𝐢𝐫 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧𝐬.   */
...
//_______________// Safe Money //_______________//
/*                 7.200.000 Max              */   
...
/* Safe Money */
    ...
    function removeAllFee() private {
        if(_developmentFee > 101 || _liquidityFee > 101) return;
